<section class="section section--lg cta-section" aria-labelledby="cta-heading">

  <div class="cta-section__shield" aria-hidden="true">
    <svg viewBox="0 0 100 115" xmlns="http://www.w3.org/2000/svg" fill="white">
  ...
  <div class="container cta-section__inner">
    ...
    <p class="cta-section__desc fade-up fade-up--delay-2">
      Every hour of delay is a risk. Submit a secure inquiry today — no names required until you're ready. We respond within 24 hours.
    </p>

    <div class="cta-section__actions fade-up fade-up--delay-3">
    ...
    <p class="cta-section__note fade-up fade-up--delay-4">
      ...
      All communications are strictly confidential. Your identity is never disclosed without consent.
    </p>
